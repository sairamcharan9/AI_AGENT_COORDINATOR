...
from app.SUB_AGENTS.data_science.sub_agents.bqml.prompts import return_instructions_bqml


from app.SUB_AGENTS.data_science.sub_agents.bigquery.agent import database_agent as bq_db_agent
from app.SUB_AGENTS.data_science.sub_agents.bigquery.tools import (
...
bqml_agent = Agent(
    model=os.getenv("BQML_AGENT_MODEL", "gemini-1.5-flash-latest"),
    name="bq_ml_agent",
